...
public class OttersGoneWild extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ottersgonewild);
        //Set up click listeners for all the buttons
        View continueButton = findViewById(R.id.Meet_button);
        continueButton.setOnClickListener(this);
        View jafarButton = findViewById(R.id.Daily_button);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.Meet_button:
                startActivity(new Intent(this, NFood.class));
                break;
            ...
            case R.id.Anatomy_button:
                startActivity(new Intent(this, Predators.class));
                break;
